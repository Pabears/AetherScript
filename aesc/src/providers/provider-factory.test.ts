...
describe('ProviderFactory', () => {
  ...
  afterEach(() => {
    // Reset the factory to its default state, ensuring it's a Map
    (ProviderFactory as any).providers = new Map([
  ...
  it('should get available providers', () => {
    ProviderFactory.registerProvider('custom', () => new class {} as any);
